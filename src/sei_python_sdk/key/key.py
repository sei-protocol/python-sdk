...
from sei_python_sdk.core import (
    AccAddress,
    AccPubKey,
    ModeInfo,
    ModeInfoSingle,
...
from sei_python_sdk.core.bech32 import get_bech
from sei_python_sdk.core.public_key import (
    PublicKey,
    address_from_public_key,
    amino_pubkey_from_public_key,
)
from sei_python_sdk.core.signature_v2 import Descriptor
from sei_python_sdk.core.signature_v2 import Single as SingleDescriptor
from sei_python_sdk.core.tx import AuthInfo, SignerInfo, SignMode, Tx
...
class Key:
    ...
    def acc_address(self) -> AccAddress:
        """Sei Bech32 account address. Default derivation via :data:`public_key` is provided.
        ...
        return AccAddress(get_bech("sei", self.raw_address.hex()))

    @property
    def val_address(self) -> ValAddress:
        """Sei Bech32 validator operator address. Default derivation via :data:`public_key` is provided.
        ...
        return ValAddress(get_bech("seivaloper", self.raw_address.hex()))

    @property
    def acc_pubkey(self) -> AccPubKey:
        """Sei Bech32 account pubkey. Default derivation via :data:`public_key` is provided.
        ...
        return AccPubKey(get_bech("seipub", self.raw_pubkey.hex()))

    @property
    def val_pubkey(self) -> ValPubKey:
        """Sei Bech32 validator pubkey. Default derivation via ``public_key`` is provided.
        ...
        return ValPubKey(get_bech("seivaloperpub", self.raw_pubkey.hex()))
