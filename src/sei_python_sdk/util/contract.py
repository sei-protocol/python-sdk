...
from sei_python_sdk.core.auth import TxInfo
from sei_python_sdk.core.broadcast import BlockTxBroadcastResult
...
def get_contract_address(
    ...
    """
    if tx_result.logs:
        contract_address = tx_result.logs[msg_index].events_by_type["wasm"]["_contract_address"][0]
