...
from sei_python_sdk.core import Coin
...
class AsyncLCDUtils(BaseAsyncAPI):
    async def validators_with_voting_power(self) -> Dict[str, dict]:
        ...
        """
        validator_set_response = await BaseAsyncAPI._try_await(self._c.tendermint.validator_set())
        next_key = ""
        while True:
            from sei_python_sdk.client.lcd import PaginationOptions
