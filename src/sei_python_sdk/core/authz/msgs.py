...
from ...sei_proto.cosmos.authz.v1beta1 import MsgExec as MsgExec_pb
from ...sei_proto.cosmos.authz.v1beta1 import MsgGrant as MsgGrant_pb
from ...sei_proto.cosmos.authz.v1beta1 import MsgRevoke as MsgRevoke_pb

from sei_python_sdk.core import AccAddress
...
class MsgExecAuthorized(Msg):
    ...
    def from_proto(cls, proto: MsgExec_pb) -> MsgExecAuthorized:
        return cls(grantee=proto.grantee, msgs=[Msg.from_proto(md) for md in proto.msgs])
...
class MsgGrantAuthorization(Msg):
    ...
    def to_proto(self) -> MsgGrant_pb:
        return MsgGrant_pb(granter=self.granter, grantee=self.grantee, grant=self.grant.to_proto())
