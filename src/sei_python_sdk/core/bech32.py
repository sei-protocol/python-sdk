...
AccAddress.__doc__ = """Sei Bech32 Account Address -- type alias of str."""

ValAddress = NewType("ValAddress", str)
ValAddress.__doc__ = """Sei Bech32 Validator Operator Address -- type alias of str."""

AccPubKey = NewType("AccPubKey", str)
AccPubKey.__doc__ = """Sei Bech32 Account Address -- type alias of str."""

ValPubKey = NewType("ValPubKey", str)
ValPubKey.__doc__ = """Sei Bech32 Validator PubKey -- type alias of str."""

# ValConsPubKey = NewType("ValConsPubKey", str)
# ValConsPubKey.__doc__ = (
#  """Sei Bech32 Validator Conensus PubKey -- type alias of str."""
# )


def is_acc_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Sei account address.
    ...
    """
    return check_prefix_and_length("sei", data, 42)
...
def to_acc_address(data: ValAddress) -> AccAddress:
    ...
    return AccAddress(bech32_encode("sei", vals[1]))


def is_val_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Sei validator operator
    address.
    ...
    """
    return check_prefix_and_length("seivaloper", data, 49)
...
def to_val_address(data: AccAddress) -> ValAddress:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return ValAddress(bech32_encode("seivaloper", vals[1]))


def is_acc_pubkey(data: str) -> bool:
    """Checks whether the provided string is a properly formatted Sei account pubkey.
    ...
    """
    return check_prefix_and_length("seipub", data, 76)
...
def to_acc_pubkey(data: ValPubKey) -> AccPubKey:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return AccPubKey(bech32_encode("seipub", vals[1]))


def is_val_pubkey(data: str) -> bool:
    """Checks whether provided string is a properly formatted Sei validator pubkey.
    ...
    """
    return check_prefix_and_length("seivaloperpub", data, 83)
...
def to_val_pubkey(data: AccPubKey) -> ValPubKey:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return ValPubKey(bech32_encode("seivaloperpub", vals[1]))


def is_valcons_pubkey(data: str) -> bool:  # -> ValConsPubKey:
    """Checks whether provided string is a properly formatted Sei validator consensus
    pubkey.
    ...
    """
    return check_prefix_and_length("seivalconspub", data, 83)
