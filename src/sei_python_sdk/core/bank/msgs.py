...
from ...sei_proto.cosmos.bank.v1beta1 import Input as Input_pb
from ...sei_proto.cosmos.bank.v1beta1 import MsgMultiSend as MsgMultiSend_pb
from ...sei_proto.cosmos.bank.v1beta1 import MsgSend as MsgSend_pb
from ...sei_proto.cosmos.bank.v1beta1 import Output as Output_pb
...
@attr.s
class MsgSend(Msg):
    """Sends native Sei assets (Luna or Sei stablecoins) from ``from_address`` to ``to_address``.
