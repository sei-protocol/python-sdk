...
import attr
from ....sei_proto.cosmos.vesting.v1beta1 import Period as Period_pb
from ....sei_proto.cosmos.vesting.v1beta1 import (
...
class Period(JSONSerializable):
    ...
    def from_amino(cls, amino: dict) -> Period:
        return cls(length=int(amino["length"]), amount=Coins.from_amino(amino["amount"]))
...
class PeriodicVestingAccount:
    ...
    def from_data(cls, data: dict) -> PeriodicVestingAccount:
        return cls(
            base_vesting_account=BaseVestingAccount.from_data(data["base_vesting_account"]),
    ...
    def from_proto(cls, proto: PeriodicVestingAccount_pb) -> PeriodicVestingAccount:
        return cls(
            base_vesting_account=BaseVestingAccount.from_proto(proto.base_vesting_account),
