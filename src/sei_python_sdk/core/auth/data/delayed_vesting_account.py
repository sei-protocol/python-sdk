...
class DelayedVestingAccount:
    ...
    def from_data(cls, data: dict) -> DelayedVestingAccount:
        return cls(base_vesting_account=BaseVestingAccount.from_data(data["base_vesting_account"]))

    @classmethod
    def from_proto(cls, proto: DelayedVestingAccount_pb) -> DelayedVestingAccount:
        return cls(base_vesting_account=BaseVestingAccount.from_proto(proto.base_vesting_account))
