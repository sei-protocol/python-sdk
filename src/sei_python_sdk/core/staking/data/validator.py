...
from ....sei_proto.cosmos.staking.v1beta1 import BondStatus
from ....sei_proto.cosmos.staking.v1beta1 import Commission as Commission_pb
from ....sei_proto.cosmos.staking.v1beta1 import CommissionRates as CommissionRates_pb
from ....sei_proto.cosmos.staking.v1beta1 import Description as Description_pb
from ....sei_proto.cosmos.staking.v1beta1 import Validator as Validator_pb

from sei_python_sdk.core import Dec, ValAddress, ValConsPubKey
...
class Description(JSONSerializable):
    ...
    Args:
        moniker: validator name, aka: \"Sein One\"
