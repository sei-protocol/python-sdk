...
from ...sei_proto.cosmos.staking.v1beta1 import MsgDelegate as MsgDelegate_pb
from ...sei_proto.cosmos.staking.v1beta1 import MsgEditValidator as MsgEditValidator_pb
from ...sei_proto.cosmos.staking.v1beta1 import MsgUndelegate as MsgUndelegate_pb

from sei_python_sdk.core import AccAddress, Coin, Dec, PublicKey, ValAddress, ValConsPubKey
...
class MsgCreateValidator(Msg):
    """Register a new validator with the Sei protocol.
