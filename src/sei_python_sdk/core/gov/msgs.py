...
import attr
from ...sei_proto.cosmos.gov.v1beta1 import MsgDeposit as MsgDeposit_pb
from ...sei_proto.cosmos.gov.v1beta1 import MsgSubmitProposal as MsgSubmitProposal_pb
from ...sei_proto.cosmos.gov.v1beta1 import MsgVote as MsgVote_pb
...
class MsgSubmitProposal(Msg):
    ...
    def from_data(cls, data: dict) -> MsgSubmitProposal:
        from sei_python_sdk.util.parse_content import parse_content
    ...
    def from_proto(cls, proto: MsgSubmitProposal_pb) -> MsgSubmitProposal:
        from sei_python_sdk.util.parse_content import parse_content_unpack_any
...
class MsgVote(Msg):
    ...
    def to_proto(self) -> MsgVote_pb:
        return MsgVote_pb(proposal_id=self.proposal_id, voter=self.voter, options=self.option)

    @classmethod
    def from_proto(cls, proto: MsgVote_pb) -> MsgVote:
        return cls(proposal_id=proto.proposal_id, voter=proto.voter, option=proto.option)
