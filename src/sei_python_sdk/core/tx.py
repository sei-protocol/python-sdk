...
from ..sei_proto.cosmos.base.abci.v1beta1 import AbciMessageLog as AbciMessageLog_pb
from ..sei_proto.cosmos.base.abci.v1beta1 import Attribute as Attribute_pb
from ..sei_proto.cosmos.base.abci.v1beta1 import StringEvent as StringEvent_pb
from ..sei_proto.cosmos.base.abci.v1beta1 import TxResponse as TxResponse_pb
from ..sei_proto.cosmos.tx.signing.v1beta1 import SignMode as SignMode_pb
from ..sei_proto.cosmos.tx.v1beta1 import AuthInfo as AuthInfo_pb
from ..sei_proto.cosmos.tx.v1beta1 import SignerInfo as SignerInfo_pb
from ..sei_proto.cosmos.tx.v1beta1 import Tx as Tx_pb
from ..sei_proto.cosmos.tx.v1beta1 import TxBody as TxBody_pb

from sei_python_sdk.core.compact_bit_array import CompactBitArray
from sei_python_sdk.core.fee import Fee
from sei_python_sdk.core.mode_info import ModeInfo, ModeInfoMulti, ModeInfoSingle
from sei_python_sdk.core.msg import Msg
from sei_python_sdk.core.public_key import (
    LegacyAminoMultisigPublicKey,
    PublicKey,
    SimplePublicKey,
)
from sei_python_sdk.core.signature_v2 import SignatureV2
from sei_python_sdk.util.json import JSONSerializable
...
class TxLog(JSONSerializable):
    ...
    def to_proto(self) -> AbciMessageLog_pb:
        ...
        return AbciMessageLog_pb(msg_index=self.msg_index, log=self.log, events=str_events)
...
class TxInfo(JSONSerializable):
    ...
    .. note::
        ...
        :meth:`TxAPI.tx_info()<sei_python_sdk.client.lcd.api.tx.TxAPI.tx_info>`
    """
