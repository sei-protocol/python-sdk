...
from ....sei_proto.ibc.core.client.v1 import MsgCreateClient as MsgCreateClient_pb
from ....sei_proto.ibc.core.client.v1 import (
    MsgSubmitMisbehaviour as MsgSubmitMisbehaviour_pb,
)
from ....sei_proto.ibc.core.client.v1 import MsgUpdateClient as MsgUpdateClient_pb
from ....sei_proto.ibc.core.client.v1 import MsgUpgradeClient as MsgUpgradeClient_pb
...
class MsgUpdateClient(Msg):
    ...
    def from_data(cls, data: dict) -> MsgUpdateClient:
        return cls(client_id=data["client_id"], header=data["header"], signer=data["signer"])
