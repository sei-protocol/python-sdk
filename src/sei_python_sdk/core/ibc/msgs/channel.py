...
import attr
from ....sei_proto.ibc.core.channel.v1 import MsgAcknowledgement as MsgAcknowledgement_pb
from ....sei_proto.ibc.core.channel.v1 import (
    MsgChannelCloseConfirm as MsgChannelCloseConfirm_pb,
)
from ....sei_proto.ibc.core.channel.v1 import (
    MsgChannelCloseInit as MsgChannelCloseInit_pb,
)
from ....sei_proto.ibc.core.channel.v1 import MsgChannelOpenAck as MsgChannelOpenAck_pb
from ....sei_proto.ibc.core.channel.v1 import (
    MsgChannelOpenConfirm as MsgChannelOpenConfirm_pb,
)
from ....sei_proto.ibc.core.channel.v1 import MsgChannelOpenInit as MsgChannelOpenInit_pb
from ....sei_proto.ibc.core.channel.v1 import MsgChannelOpenTry as MsgChannelOpenTry_pb
from ....sei_proto.ibc.core.channel.v1 import MsgRecvPacket as MsgRecvPacket_pb
from ....sei_proto.ibc.core.channel.v1 import MsgTimeout as MsgTimeout_pb

from sei_python_sdk.core.ibc.data.channel import Channel, Packet
from sei_python_sdk.core.ibc.data.client import Height
...
class MsgChannelCloseInit(Msg):
    ...
    def from_proto(cls, proto: MsgChannelOpenInit_pb) -> MsgChannelCloseInit:
        return cls(port_id=proto.port_id, channel_id=proto.channel_id, signer=proto.signer)
