...
from ....sei_proto.ibc.core.connection.v1 import (
...
from sei_python_sdk.core.ibc.data import Height
from sei_python_sdk.core.ibc.data.connection import Counterparty, Version
