...
from ....sei_proto.ibc.core.client.v1 import Height as Height_pb
from ....sei_proto.ibc.core.client.v1 import (
    IdentifiedClientState as IdentifiedClientState_pb,
)
from ....sei_proto.ibc.core.client.v1 import Params as Params_pb
...
class ClientConsensusStates(JSONSerializable):
    ...
    def from_data(cls, data: dict) -> ClientConsensusStates:
        return cls(
            client_id=data["client_id"],
            consensus_states=[
                ConsensusStateWithHeight.from_data(state) for state in data["consensus_states"]
            ],
        )
    ...
    def from_proto(cls, proto: ClientConsensusStates_pb) -> ClientConsensusStates:
        return cls(
            ...
            consensus_states=[
                ConsensusStateWithHeight.from_proto(state) for state in proto.consensus_states
            ],
        )
