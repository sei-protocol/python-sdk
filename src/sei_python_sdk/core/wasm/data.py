...
import attr
from ...sei_proto.cosmwasm.wasm.v1 import AbsoluteTxPosition as AbsoluteTxPosition_pb
from ...sei_proto.cosmwasm.wasm.v1 import AccessConfig as AccessConfig_pb
from ...sei_proto.cosmwasm.wasm.v1 import AccessConfigUpdate as AccessConfigUpdate_pb
from ...sei_proto.cosmwasm.wasm.v1 import AccessType
from ...sei_proto.cosmwasm.wasm.v1 import AccessTypeParam as AccessTypeParam_pb
from ...sei_proto.cosmwasm.wasm.v1 import ContractCodeHistoryEntry as HistoryEntry_pb
from ...sei_proto.cosmwasm.wasm.v1 import ContractCodeHistoryOperationType
...
class AbsoluteTxPosition(JSONSerializable):
    ...
    def to_proto(self) -> AbsoluteTxPosition_pb:
        return AbsoluteTxPosition_pb(block_height=self.block_height, tx_index=self.tx_index)
