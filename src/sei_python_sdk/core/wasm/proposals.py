...
from ...sei_proto.cosmwasm.wasm.v1 import ClearAdminProposal as ClearAdminProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import (
...
from ...sei_proto.cosmwasm.wasm.v1 import PinCodesProposal as PinCodesProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import StoreCodeProposal as StoreCodeProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import SudoContractProposal as SudoContractProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import UnpinCodesProposal as UnpinCodesProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import UpdateAdminProposal as UpdateAdminProposal_pb
from ...sei_proto.cosmwasm.wasm.v1 import (
    UpdateInstantiateConfigProposal as UpdateInstantiateConfigProposal_pb,
)

from sei_python_sdk.core.bech32 import AccAddress
from sei_python_sdk.core.coins import Coins
from sei_python_sdk.core.wasm.data import AccessConfig, AccessConfigUpdate
from sei_python_sdk.util.json import JSONSerializable
from sei_python_sdk.util.remove_none import remove_none
...
class ClearAdminProposal(JSONSerializable):
    ...
    def from_proto(cls, proto: ClearAdminProposal_pb):
        return cls(title=proto.title, description=proto.description, contract=proto.contract)
...
class StoreCodeProposal(JSONSerializable):
    ...
    def from_data(cls, data):
        return cls(
            ...
            instantiate_permission=AccessConfig.from_data(data["instantiate_permission"]),
        )
